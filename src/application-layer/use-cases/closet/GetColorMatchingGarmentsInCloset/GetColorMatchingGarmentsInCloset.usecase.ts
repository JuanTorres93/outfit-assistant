...
export type GetColorMatchingGarmentsInClosetUsecaseRequest = {
  closetId: string;
  garmentId: string;
};

export class GetColorMatchingGarmentsInClosetUsecase {
  constructor(
  ...
  async execute(request: GetColorMatchingGarmentsInClosetUsecaseRequest): Promise<Garment[]> {
    ...
    return this.colorMatchService.getMatchingGarments(targetGarment, hydratedGarments);
  }
}
